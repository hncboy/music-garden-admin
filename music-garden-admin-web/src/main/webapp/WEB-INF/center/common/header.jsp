    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<%=request.getContextPath()%>/">
                <img src="<%=request.getContextPath()%>/static/pages/img/logos/logo.png" alt="logo"
                     class="logo-default"/>
            </a>
        ...
        <a href="javascript:;" class="menu-toggler responsive-toggler" data-toggle="collapse"
           data-target=".navbar-collapse" style="width: 19px; height: 19px;">
            <span style="top: 8px;"></span>
        </a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="<%=request.getContextPath()%>/center.shtml" class="dropdown-toggle" data-toggle="dropdown"
